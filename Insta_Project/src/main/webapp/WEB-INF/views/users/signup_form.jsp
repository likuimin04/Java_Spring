...
<div class="container">
	...
	<form action="signup.do" method="post" id="myForm" novalidate>
		...
		<div class="form-group">
			...
			<input class="form-control" type="text" placeholder="이름 입력..." name="name" id="name"/>
			<small class="form-text text-muted">2글자~10글자 이내로 입력하세요.</small>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="invalid-feedback">주소가 맞는지 확인 하세요.</div>
		</div>
		<div class="form-group">
			<label for="tel">전화 번호</label>
			<input class="form-control" type="text" placeholder="전화번호 입력..." name="tel" id="tel"/>
			<div class="invalid-feedback">중복된 전화번호 입니다.</div>
		</div>
