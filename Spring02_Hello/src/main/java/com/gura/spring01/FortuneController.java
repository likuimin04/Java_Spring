...
public class FortuneController {
	...
	public String fortune(HttpServletRequest request) {//리턴 type 은 String, 메소드명은 마음대로 지을수 있다.
		 ...
		 * 
		 * 그럼으로 해당 위치를 찾아 jsp 파일을 만들어서 응답하면 된다.
		 */
		return "fortune";
	}
}
